...
function serverInitialization.onStartup()
	...
	logger.info("Loaded {} npcs and spawned {} monsters", Game.getNpcCount(), Game.getMonsterCount())
	logger.info("Loaded {} towns with {} houses in total", #Game.getTowns(), #Game.getHouses())
